        ...
        <div className="content-container">
          ...
          <div className="scoring-content">
            ...
            <p className="summary-text">
              The maximum score per pick is 600 points (100 + 200 + 100 + 100 + 100) and the minimum score is 0 points. Your total score will be the sum of points earned across all 30 picks.
            </p>
          </div>
        </div>
      </div>
