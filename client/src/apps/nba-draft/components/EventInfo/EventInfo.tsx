...
const EventInfo: React.FC<EventInfoProps> = ({ lockTime, isLocked, startTime }) => {
  ...
  const getLockTimeColor = () => {
    if (isLocked) return 'red';
    if (lockTime.includes('d')) return 'green';
    return 'red';
  };

  return (
    <div className="event-info-container" data-testid="event-info-container">
      <h1 className="event-title">NBA Draft 2025</h1>
      
      <div className="event-details">
        <div className="event-detail-item">
          <span className="event-detail-label">Location:</span>
          <span className="event-detail-value">Brooklyn, New York</span>
        </div>
        <div className="event-detail-item">
        ...
        <div className="event-detail-item">
          ...
          <span className="event-detail-value" style={{ color: getLockTimeColor() }}>
